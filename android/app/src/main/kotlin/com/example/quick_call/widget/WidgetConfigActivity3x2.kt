...
/**
 * 3×2 위젯 설정 Activity (6개 버튼 선택)
 */
class WidgetConfigActivity3x2 : Activity() {
    ...
    private lateinit var allButtonsAdapter: SimpleAllButtonsAdapter3x2
    ...
    private fun setupAdapters() {
        allButtonsAdapter = SimpleAllButtonsAdapter3x2(allButtons, selectedButtons, maxButtons) { button ->
    ...
    private fun saveConfiguration() {
        ...
        val prefs = getSharedPreferences("QuickCallWidgetPrefs", Context.MODE_PRIVATE)
        prefs.edit().putString("widget_data_3x2_$appWidgetId", jsonArray.toString()).apply()
        
        val appWidgetManager = AppWidgetManager.getInstance(this)
        SpeedDialWidgetProvider3x2.updateAppWidget(this, appWidgetManager, appWidgetId)
...
class SimpleAllButtonsAdapter3x2(
