// android/app/src/main/kotlin/com/example/quick_call/widget/SpeedDialWidgetProvider2x3.kt
...
/**
 * Quick Call 2×3 위젯 Provider (6개 버튼)
 */
class SpeedDialWidgetProvider2x3 : AppWidgetProvider() {

    companion object {
        private const val PREFS_NAME = "QuickCallWidgetPrefs"
        private const val PREF_PREFIX = "widget_data_2x3_"
        private const val PREF_ALL_BUTTONS = "all_buttons_data"
        private const val ACTION_CALL = "com.oceancode.quick_call.ACTION_CALL_2X3"
        ...
        fun updateAppWidget(
            ...
            val views = RemoteViews(context.packageName, R.layout.widget_speed_dial_2x3)
        ...
        fun updateAllWidgets(context: Context) {
            val intent = Intent(context, SpeedDialWidgetProvider2x3::class.java).apply {
                action = AppWidgetManager.ACTION_APPWIDGET_UPDATE
            }
            
            val ids = AppWidgetManager.getInstance(context)
                .getAppWidgetIds(ComponentName(context, SpeedDialWidgetProvider2x3::class.java))
